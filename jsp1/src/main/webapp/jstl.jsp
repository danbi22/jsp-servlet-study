...
<html>
		...
		<body>
                ...
                <%-- JSTL 사용하기: 
                        ...
                        2. JSTL을 사용하는 JSP 파일에서 taglib 지시문을 설정. -> 필수 prefix, uri
                 --%>
                 
                 <%
                 // HTML 리스트 아이템으로 사용할 더미 데이터 생성:
                 String[] sites = {"YouTube", "Instargram", "Facebook"};
                 // -> scriptlet에서 선언한 지역 변수는 EL에서 사용할 수 없음.
